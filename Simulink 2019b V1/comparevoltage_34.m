...
% This code compares the node voltage obtained from Simulink model against the benchmark voltages for IEEE 34 bus system 
% Run the simulink model first and run this code to compare node voltages
Vs34=V34(end,:)';
Vsim=reshape(Vs34,3,length(Vs34)/3)';% Three Phase Steady State Node Voltage of All Nodes
